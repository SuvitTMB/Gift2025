...
function CalGift() {
  ...
  var xSumUnitPrice17 = parseFloat(document.getElementById("UnitPrice17").value * document.getElementById("OrderGiftID17").value);
  var xSumUnitPrice18 = parseFloat(document.getElementById("UnitPrice18").value * document.getElementById("OrderGiftID18").value);
  ...
  var CC = parseFloat(document.getElementById("OrderGiftID14").value)+ parseFloat(document.getElementById("OrderGiftID15").value) + parseFloat(document.getElementById("OrderGiftID16").value)+ parseFloat(document.getElementById("OrderGiftID17").value)+ parseFloat(document.getElementById("OrderGiftID18").value);
  //var CC = parseFloat(document.getElementById("OrderGiftID14").value)+ parseFloat(document.getElementById("OrderGiftID15").value) + parseFloat(document.getElementById("OrderGiftID16").value)+ parseFloat(document.getElementById("OrderGiftID17").value) + parseFloat(document.getElementById("OrderGiftID18").value);
  ...
  var ZZ = parseFloat(xSumUnitPrice12) + parseFloat(xSumUnitPrice13) + parseFloat(xSumUnitPrice14) + parseFloat(xSumUnitPrice15) + parseFloat(xSumUnitPrice16) + parseFloat(xSumUnitPrice17) + parseFloat(xSumUnitPrice18);
  //var ZZ = parseFloat(xSumUnitPrice12) + parseFloat(xSumUnitPrice13) + parseFloat(xSumUnitPrice14) + parseFloat(xSumUnitPrice15) + parseFloat(xSumUnitPrice16) + parseFloat(xSumUnitPrice17) + parseFloat(xSumUnitPrice18);
  ...
  $("#SumUnitPrice17").html(numberWithCommas(xSumUnitPrice17));
  $("#SumUnitPrice18").html(numberWithCommas(xSumUnitPrice18));
