...
function ShowProfile() {
  ...
  str += '<div style="color:#fff; font-size: 13px;padding:2px;font-weight: 400;line-height: 1.3;margin-bottom: 10px;">'+ sessionStorage.getItem("EmpPosition_Newyear")+'';
  str += '<br>'+ sessionStorage.getItem("EmpBR_Newyear")+'<br>'+ sessionStorage.getItem("EmpZone_Newyear")+'<br>'+ sessionStorage.getItem("EmpRH_Newyear")+'</div>';
